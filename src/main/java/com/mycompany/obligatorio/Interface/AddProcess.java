...
public class AddProcess extends javax.swing.JFrame {
    ...
    private void SaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaveMouseClicked
        ...
        Utils.operativeSystem.Load(new Process(path, name, size, execTime, timeBetweenIO, TimeToWaitIO));
        this.setVisible(false);
        Utils.ventana.DisplayProcess(Utils.operativeSystem.Memory.getAllProcessInMemory());
